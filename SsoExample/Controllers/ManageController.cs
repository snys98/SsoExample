...
using SsoExample.Models.ManageViewModels;
...
namespace SsoExample.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> SendVerificationEmail(IndexViewModel model)
        {
            ...
            var email = user.Email;
            await _emailSender.SendEmailAsync(email, "确认操作",
               $"请点击<a href='{callbackUrl}'>此处</a>来确认您的操作.");
        ...
        private string GenerateQrCodeUri(string userName, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Geexbox.Identity"),
